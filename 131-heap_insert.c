...
/**
 * swap - Exchanges two nodes within a binary tree
 * @a: First node
 * @b: Second node
...
/**
 * convert - Transforms a number into a string representation with a given base
 * @num: Input number
 * @base: Input base
 * @lowercase: Flag indicating if hexadecimal values should be lowercase
...
/**
 * insert - Helper function to insert a node at the correct location
 * @root: Double pointer to the root of a max heap
