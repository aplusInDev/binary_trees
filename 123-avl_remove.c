...
/**
 * bal - Measure balance factor of an AVL tree.
...
/**
 * successor - Find the next successor (minimum value) in the right subtree.
...
/**
 *remove_type - function that  remove a node depending on its children configuration.
 *@root: Node to remove.
